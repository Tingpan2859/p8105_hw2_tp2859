...
dimension (rows: 1868 x columns: 19)
...
add_compliant_A
cat('There are',The_A_train_stations, 'distinct stations serve the A train. Of the stations that serve the A train, there are', add_compliant_A, 'ADA compliant.')
```
...
cat("The average viewership in Season 1:",avg_viewership_s1$avg_viewership,"\n")
cat("The average viewership in Season 5:",avg_viewership_s5$avg_viewership,"\n")
